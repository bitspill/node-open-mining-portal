...
int main(int argc, char* argv[])
{
	...
	uint8_t *	xpec4_512 = groestl4;
	uint8_t		 zr5_4[] = "\65d722c1b43510e251ae8d2283ea90c9fd10db6963c7d39f16bb19a9fe43281d17a8ebaf6eaeb3edc4b0307646995c42ae0d425a4716e648df2cfa8102dce498";
	...
	#ifdef TEST_VERBOSELY
	printf("%12s", "Expected: ");
	for(i=0; i< 64; i++) { printf("%02x", zr5_4[i]); }
	printf("\n");
	printf("%12s", "Got: ");
